...
<html lang="en">
<head>
	<title>JULIERME MONTEIRO - 20620</title>
	...
	<meta name="description" content="JULIERME MONTEIRO - 20620">
					...
					<li class="header-nav-brand" >
						<div class="brand-holder">
							<a href="../../html/dashboards/dashboard.html">
								<span class="text-lg color2 text-bold text-primary">JULIERME 20620</span>
							</a>
						</div>
					</li>
					<li>
				...
				<ul id="main-menu" class="gui-controls">
					...
					<li class="gui-folder">
						...
						<ul>
							...
							<li><a href="{{ route('cliente.cliente.index') }}" class="active"><span class="title">Eleitores</span></a></li>
						</ul><!--end /submenu -->
					</li><!--end /menu-li -->
					<!-- END FORMS -->
