...
<html lang="en">
<head>
    <title>JULIERME MONTEIRO</title>

    <!-- BEGIN META -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="keywords" content="Enegia solar,energia, fotovoltaica, JULIERME MONTEIRO - VEREADOR 20620">
    <meta name="description" content="JULIERME MONTEIRO - VEREADOR 20620">
        ...
        <div class="card-body">
            <div class="row text-center">
                <div class="form-group">
                    <img align="middle" src="/img/Julierme02.png" alt="Italian Trulli">
                </div>
