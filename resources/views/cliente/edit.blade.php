                ...
                <form method="POST" action="{{ route('cliente.cliente.update', $cliente->id) }}" accept-charset="UTF-8" id="edit_cliente_form" name="edit_cliente_form" class="form-horizontal">
                    ...
                    <div class="card">
                        <div class="card-head style-primary">
                            <header>Editar Eleitores</header>
                            <div class="tools">
                                <div class="btn-group">
                                    <a href="{{ route('cliente.cliente.index') }}" class="btn btn-primary" title="Listar todos Eleitores">
                                        <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
                                    </a>
                                    <a href="{{ route('cliente.cliente.create') }}" class="btn btn-primary" title="Criar novo Eleitor">
